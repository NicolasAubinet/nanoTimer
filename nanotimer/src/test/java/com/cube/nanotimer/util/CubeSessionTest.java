...
public class CubeSessionTest {
  ...
  public void testBestWorst() {
    ...
    Assert.assertEquals(-1, cs.getBestTimeInd(6));
    Assert.assertEquals(-1, cs.getWorstTimeInd(6));
    ...
    Assert.assertEquals(2, cs.getWorstTimeInd(5));
    Assert.assertEquals(1, cs.getBestTimeInd(6));
    Assert.assertEquals(2, cs.getWorstTimeInd(6));
    Assert.assertEquals(-1, cs.getBestTimeInd(12));
    Assert.assertEquals(-1, cs.getWorstTimeInd(12));

    cs.addTime(8000);
    cs.addTime(9000); // 9 8 5 3 10 4 6 7
    ...
    cs.addTime(2000);
    cs.addTime(7000); // 7 2 9 8 5 3 10 4 6 7
    Assert.assertEquals(1, cs.getBestTimeInd(5));
    Assert.assertEquals(2, cs.getWorstTimeInd(5));
    Assert.assertEquals(-1, cs.getBestTimeInd(12));
    Assert.assertEquals(-1, cs.getWorstTimeInd(12));

    cs.addTime(5000); // 5 7 2 9 8 5 3 10 4 6 7
    Assert.assertEquals(2, cs.getBestTimeInd(5));
    Assert.assertEquals(3, cs.getWorstTimeInd(5));
    Assert.assertEquals(-1, cs.getBestTimeInd(12));
    Assert.assertEquals(-1, cs.getWorstTimeInd(12));

    cs.addTime(11000); // 11 5 7 2 9 8 5 3 10 4 6 7
    Assert.assertEquals(3, cs.getBestTimeInd(5));
    Assert.assertEquals(0, cs.getWorstTimeInd(5));
    Assert.assertEquals(3, cs.getBestTimeInd(12));
    Assert.assertEquals(0, cs.getWorstTimeInd(12));

    cs.addTime(8000); // 8 11 5 7 2 9 8 5 3 10 4 6 7
    ...
    cs.addTime(3000); // 3 8 11 5 7 2 9 8 5 3 10 4 6 7
