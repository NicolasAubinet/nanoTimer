...
public class DBHelper extends SQLiteOpenHelper {
  ...
  public void onCreate(SQLiteDatabase db) {
    ...
    db.execSQL("CREATE TABLE " + DB.TABLE_TIMEHISTORY + "(" +
        DB.COL_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
        DB.COL_TIMEHISTORY_TIMESTAMP + " REAL, " +
        DB.COL_TIMEHISTORY_TIME + " REAL, " +
        DB.COL_TIMEHISTORY_SCRAMBLE + " TEXT, " +
        DB.COL_TIMEHISTORY_AVG5 + " REAL, " +
        DB.COL_TIMEHISTORY_AVG12 + " REAL, " +
        DB.COL_TIMEHISTORY_AVG100 + " REAL, " +
        DB.COL_TIMEHISTORY_AVG1000 + " REAL, " +
